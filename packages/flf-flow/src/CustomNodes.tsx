...
import { BookOpen, Zap, Target, Play, Flag } from "lucide-react";
...
export const LearnNode = memo(({ data, selected }: NodeProps) => {
    ...
    const hasContent =
        data.markdown && (data.markdown as string).trim().length > 0;
            ...
            <div className="p-4">
                ...
                <div className="mb-3 flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-slate-500">Quiz challenge</p>
                    </div>
                </div>
        ...
        >
            <div className="p-4">
                ...
                <div className="text-center">
                    ...
                    <p className="text-xs text-slate-500">Flow entry point</p>
                </div>
            </div>
