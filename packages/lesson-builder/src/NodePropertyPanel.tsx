...
export default function NodePropertyPanel({
    ...
    const accentColor = isLearnNode ? "blue" : "orange";
    ...
    return (
        <div className="flex flex-1 flex-col overflow-hidden bg-gradient-to-b from-white to-slate-50/50" style={{ minHeight: 0 }}>
            {/* Enhanced Header */}
            <div className="inspector-header-enhanced">
                <div className="flex items-start gap-4">
                    <div className={`inspector-icon-wrapper ${accentColorClass}`}>
                        {isLearnNode ? (
            ...
            <div className="flex-1 overflow-y-auto inspector-content">
                ...
                <div className="inspector-section">
                    <div className="inspector-section-header">
                        ...
                        <span className="inspector-section-title">Basic Settings</span>
                    </div>
                    ...
                    {isLearnNode && (
                        <div className="inspector-form-group">
                            <Label htmlFor="markdown" className="inspector-label">
                                Content (Markdown)
                            </Label>
                            <Textarea
                                id="markdown"
                    ...
                    {!isLearnNode && (
                        <div className="inspector-form-group">
                            ...
                            >
                                <SelectTrigger className={`inspector-select-enhanced ${accentBorderClass}`}>
                                ...
                                <SelectContent 
                                    ...
                                    position="popper"
                                >
                                    <SelectItem value="intro.quiz" className="inspector-select-item">
                                        <span className="inspector-select-item-text">intro.quiz</span>
                                    </SelectItem>
                                    <SelectItem value="final-test.quiz" className="inspector-select-item">
                                        <span className="inspector-select-item-text">final-test.quiz</span>
                                    </SelectItem>
                                    <SelectItem value="vocab-check.quiz" className="inspector-select-item">
                                        <span className="inspector-select-item-text">vocab-check.quiz</span>
                                    </SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                ...
                <div className="inspector-section">
                    <div className="inspector-section-header">
                        ...
                        <span className="inspector-section-title">Mission Rules</span>
                    </div>

                    {isLearnNode ? (
                        <div className="inspector-form-group">
                            <div className="flex items-center justify-between mb-3">
                                <Label htmlFor="min_prog" className="inspector-label">
                                    Minimum Viewing Progress
                                </Label>
                                <div className={`inspector-badge ${accentBgClass}`}>
                                    <TrendingUp size={12} />
                                    <span className="font-bold">{minProgress}%</span>
                                </div>
                            </div>
                            <div className="relative">
                                <Input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                                        ...
                                        handleRuleChange("min_prog", value / 100);
                                    }}
                                    className={`inspector-input inspector-input-with-suffix ${accentBorderClass}`}
                                />
                                <span className="inspector-input-suffix">%</span>
                            </div>
                            <div className="mt-3 bg-slate-100 rounded-full h-2 overflow-hidden">
                                <div 
                                    className={`h-full rounded-full transition-all duration-300 ${
                                        isLearnNode ? "bg-blue-500" : "bg-orange-500"
                                    }`}
                                    style={{ width: `${minProgress}%` }}
                                />
                            </div>
                            <p className="inspector-hint mt-2">
                                Students must view at least this percentage to proceed
                            </p>
                        </div>
                    ) : (
                        <div className="inspector-form-group">
                            <div className="flex items-center justify-between mb-3">
                                <Label htmlFor="passing_score" className="inspector-label">
                                    Passing Score
                                </Label>
                                <div className={`inspector-badge ${accentBgClass}`}>
                                    <Target size={12} />
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                                        const value = Math.max(0, Math.min(100, parseFloat(e.target.value) || 0));
                                        handleRuleChange("passing_score", value / 100);
                                    }}
                                    className={`inspector-input inspector-input-with-suffix ${accentBorderClass}`}
                                />
                                <span className="inspector-input-suffix">%</span>
